...
public static class Tf2Ps3SourceClcMoveContractReducer
{
        ...
        string outputPath)
    {
        ...
        var report = new Tf2Ps3SourceClcMoveContractReport(
            ...
            fieldLayout,
            [
                "Use Ps3SourceNativeToClcMoveBoundaryResolver for direct raw CLC_Move bodies, attached type-2 raw bodies, and exact bit-sidecar CLC_Move packets before falling back to heuristic intent decoding.",
